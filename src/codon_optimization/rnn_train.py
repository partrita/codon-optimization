...
from tensorflow.keras.layers import GRU, Dense, TimeDistributed, Bidirectional, Dropout
...
my_model = model_embed(
    tmp_x.shape,
    preproc_dna.shape[1],
    len(aa_tokenizer.word_index) + 1,
    len(dna_tokenizer.word_index) + 1,
)
...
callbacks = [
    ...
    ModelCheckpoint("rnn_model_newest.h5"),
]
